...
import { Float, OrbitControls, Preload, View, useGLTF } from '@react-three/drei'
...
const Computers = ({ isMobile}) => {
  ...
  return (
    ...
    <mesh>
      ...
      <primitive object={computer.scene} scale={isMobile ? 0.70 : 0.75} position={isMobile ? [0, -3, -2.2] : [0, -3.10, -1.5]} rotation={[-0.01, -0.2, -0.1]}  />
    </mesh>
    </Float>
  )
}
