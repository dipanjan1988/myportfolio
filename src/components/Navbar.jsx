    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <Link to="/home" className="flex items-center gap-2" onClick={() => {
          ...
          <img src={dipanjantransparentlogo} alt="dipanjantransparentlogo" className="w-9 h-9 object-contain" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex">Dipanjan's &nbsp; <span className="sm:block hidden"> | portfolio</span></p>
        </Link>
